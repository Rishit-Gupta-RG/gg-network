...
class Minecraft(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
    @commands.slash_command(name="check", brief="Checks status for GG Network", help="Want to check whether the server is online or not? just type the command an you'll get some information.", enabled=True)
